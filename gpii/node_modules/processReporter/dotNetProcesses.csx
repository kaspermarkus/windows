...
public class Startup
{
    public async Task<object> Invoke(dynamic input)
    {
        ...
        Console.Write("CSX: Invoke called with the input ");
        ...
        if (input != null) {
            if (input.GetType() == typeof(System.Int32)) {
                ...
                foreach (ManagementObject p in someProcesses) {
                    Console.WriteLine("Hit on " + p + " in processes");
                    result.Add(makeProcInfo(p));
                }
                if (someProcesses.Length == 0) {
                    Console.WriteLine();
                }
            }
        }
    ...
    public static ProcInfo makeProcInfo(ManagementObject process) {
        Console.Write("makeProcInfo called with ");
        object propValue;
        ...
        Console.Write("(Command, pid) = (");
        Console.Write(procInfo.command);
        Console.Write(", ");
        Console.Write(procInfo.pid);
        Console.WriteLine(")");
