...
windows.registrySettingsHandler.get = function (payload) {
    return gpii.invokeSettingsHandler(payload, windows.registrySettingsHandler.getImpl);
};

windows.registrySettingsHandler.set = function (payload) {
    return gpii.invokeSettingsHandler(payload, windows.registrySettingsHandler.setImpl);
};
